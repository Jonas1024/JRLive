...
#import "JRGPUImageEmptyFilter.h"
#import "JRLiveVideoConfiguration.h"

@interface JRVideoCapture ()

@property (nonatomic, strong) GPUImageVideoCamera *videoCamera;
@property (nonatomic, strong) JRGPUImageBeautyFilter *beautyFilter;
...
@implementation JRVideoCapture
@synthesize torch = _torch;
@synthesize beautyLevel = _beautyLevel;
@synthesize brightLevel = _brightLevel;
@synthesize zoomScale = _zoomScale;

- (instancetype)initWithVideoConfiguration:(JRLiveVideoConfiguration *)configuration
{
    if (self = [super init]) {
...
- (void)reloadFilter
{
    ...
    if (self.beautyFace) {
        self.output = [[JRGPUImageEmptyFilter alloc] init];
        self.filter = [[JRGPUImageBeautyFilter alloc] init];
        self.beautyFilter = (JRGPUImageBeautyFilter*)self.filter;
    } else {
        self.output = [[JRGPUImageEmptyFilter alloc] init];
        self.filter = [[JRGPUImageEmptyFilter alloc] init];
