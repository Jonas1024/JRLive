...
NSString *const kJRGPUImageBeautyFragmentShaderString = SHADER_STRING
                                                        (
...
@implementation JRGPUImageBeautyFilter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kJRGPUImageBeautyFragmentShaderString])) {
        return nil;
    }
