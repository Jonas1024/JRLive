...
@interface JRLivePreview ()<JRLiveSessionDelegate>
...
@property (nonatomic, strong) JRLiveSession *session;
@property (nonatomic, strong) UILabel *stateLabel;

@end

@implementation JRLivePreview
...
#pragma mark -- JRStreamingSessionDelegate
...
- (JRLiveSession *)session {
    if (!_session) {
        ...
        JRLiveVideoConfiguration *videoConfiguration = [JRLiveVideoConfiguration new];
        ...
        videoConfiguration.sessionPreset = JRCaptureSessionPreset720x1280;
        _session = [[JRLiveSession alloc] initWithAudioConfiguration:[JRLiveAudioConfiguration defaultConfiguration] videoConfiguration:videoConfiguration captureType:JRLiveCaptureDefaultMask];

        /**    自己定制单声道  */
        /*
           JRLiveAudioConfiguration *audioConfiguration = [JRLiveAudioConfiguration new];
           audioConfiguration.numberOfChannels = 1;
           audioConfiguration.audioBitrate = JRLiveAudioBitRate_64Kbps;
           audioConfiguration.audioSampleRate = JRLiveAudioSampleRate_44100Hz;
           _session = [[JRLiveSession alloc] initWithAudioConfiguration:audioConfiguration videoConfiguration:[JRLiveVideoConfiguration defaultConfiguration]];
         */
        ...
        /*
           ...
           audioConfiguration.audioBitrate = JRLiveAudioBitRate_96Kbps;
           audioConfiguration.audioSampleRate = JRLiveAudioSampleRate_44100Hz;
           _session = [[JRLiveSession alloc] initWithAudioConfiguration:audioConfiguration videoConfiguration:[JRLiveVideoConfiguration defaultConfiguration]];
         */
        ...
        /*
           ...
           videoConfiguration.sessionPreset = JRCaptureSessionPreset540x960;

           _session = [[JRLiveSession alloc] initWithAudioConfiguration:audioConfiguration videoConfiguration:videoConfiguration];
         */
        ...
        /*
           JRLiveAudioConfiguration *audioConfiguration = [JRLiveAudioConfiguration new];
           audioConfiguration.numberOfChannels = 2;
           audioConfiguration.audioBitrate = JRLiveAudioBitRate_128Kbps;
           audioConfiguration.audioSampleRate = JRLiveAudioSampleRate_44100Hz;
           ...
           videoConfiguration.sessionPreset = JRCaptureSessionPreset360x640;
    ...
    if (!_startLiveButton) {
        ...
        [_startLiveButton addBlockForControlEvents:UIControlEventTouchUpInside block:^(id sender) {
            ...
            if (_self.startLiveButton.selected) {
                ...
                JRLiveStreamInfo *stream = [JRLiveStreamInfo new];
                stream.url = @"rtmp://114312.livepush.myqcloud.com/live/live?txSecret=712305f3516e0604a882c178709e59a1&txTime=5F745C23";
