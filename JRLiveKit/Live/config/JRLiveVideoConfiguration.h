...
typedef NS_ENUM (NSUInteger, JRLiveVideoSessionPreset){
    /// 低分辨率
    JRCaptureSessionPreset360x640 = 0,
    /// 中分辨率
    JRCaptureSessionPreset540x960 = 1,
    /// 高分辨率
    JRCaptureSessionPreset720x1280 = 2
};

/// 视频质量
typedef NS_ENUM (NSUInteger, JRLiveVideoQuality){
    /// 分辨率： 360 *640 帧数：15 码率：500Kps
    JRLiveVideoQuality_Low1 = 0,
    /// 分辨率： 360 *640 帧数：24 码率：800Kps
    JRLiveVideoQuality_Low2 = 1,
    /// 分辨率： 360 *640 帧数：30 码率：800Kps
    JRLiveVideoQuality_Low3 = 2,
    /// 分辨率： 540 *960 帧数：15 码率：800Kps
    JRLiveVideoQuality_Medium1 = 3,
    /// 分辨率： 540 *960 帧数：24 码率：800Kps
    JRLiveVideoQuality_Medium2 = 4,
    /// 分辨率： 540 *960 帧数：30 码率：800Kps
    JRLiveVideoQuality_Medium3 = 5,
    /// 分辨率： 720 *1280 帧数：15 码率：1000Kps
    JRLiveVideoQuality_High1 = 6,
    /// 分辨率： 720 *1280 帧数：24 码率：1200Kps
    JRLiveVideoQuality_High2 = 7,
    /// 分辨率： 720 *1280 帧数：30 码率：1200Kps
    JRLiveVideoQuality_High3 = 8,
    /// 默认配置
    JRLiveVideoQuality_Default = JRLiveVideoQuality_Low2
};

NS_ASSUME_NONNULL_BEGIN

@interface JRLiveVideoConfiguration : NSObject
...
///< 分辨率
@property (nonatomic, assign) JRLiveVideoSessionPreset sessionPreset;
