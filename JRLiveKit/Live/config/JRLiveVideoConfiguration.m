...
@implementation JRLiveVideoConfiguration

#pragma mark -- LifeCycle

+ (instancetype)defaultConfiguration {
    JRLiveVideoConfiguration *configuration = [JRLiveVideoConfiguration defaultConfigurationForQuality:JRLiveVideoQuality_Default];
    return configuration;
}

+ (instancetype)defaultConfigurationForQuality:(JRLiveVideoQuality)videoQuality {
    JRLiveVideoConfiguration *configuration = [JRLiveVideoConfiguration defaultConfigurationForQuality:videoQuality outputImageOrientation:UIInterfaceOrientationPortrait];
    return configuration;
}

+ (instancetype)defaultConfigurationForQuality:(JRLiveVideoQuality)videoQuality outputImageOrientation:(UIInterfaceOrientation)outputImageOrientation {
    JRLiveVideoConfiguration *configuration = [JRLiveVideoConfiguration new];
    switch (videoQuality) {
    case JRLiveVideoQuality_Low1:{
        configuration.sessionPreset = JRCaptureSessionPreset360x640;
    ...
    case JRLiveVideoQuality_Low3: {
        ...
        break;
    case JRLiveVideoQuality_Medium1:{
        configuration.sessionPreset = JRCaptureSessionPreset540x960;
        configuration.videoFrameRate = 15;
        configuration.videoMaxFrameRate = 15;
        configuration.videoMinFrameRate = 10;
        configuration.videoBitRate = 800 * 1000;
        ...
        break;
    case JRLiveVideoQuality_Medium2:{
        configuration.sessionPreset = JRCaptureSessionPreset540x960;
        configuration.videoFrameRate = 24;
        configuration.videoMaxFrameRate = 24;
        configuration.videoMinFrameRate = 12;
        ...
        break;
    case JRLiveVideoQuality_Medium3:{
        configuration.sessionPreset = JRCaptureSessionPreset540x960;
        configuration.videoFrameRate = 30;
        configuration.videoMaxFrameRate = 30;
        configuration.videoMinFrameRate = 15;
        ...
        break;
    case JRLiveVideoQuality_High1:{
        configuration.sessionPreset = JRCaptureSessionPreset720x1280;
        configuration.videoFrameRate = 15;
        configuration.videoMaxFrameRate = 15;
        configuration.videoMinFrameRate = 10;
        configuration.videoBitRate = 1000 * 1000;
...
- (NSString *)avSessionPreset {
    ...
    case JRCaptureSessionPreset360x640:{
        avSessionPreset = AVCaptureSessionPreset640x480;
    }
        break;
    case JRCaptureSessionPreset540x960:{
        avSessionPreset = AVCaptureSessionPresetiFrame960x540;
    }
        break;
    case JRCaptureSessionPreset720x1280:{
...
- (void)setSessionPreset:(JRLiveVideoSessionPreset)sessionPreset{
    _sessionPreset = sessionPreset;
    _sessionPreset = [self supportSessionPreset:sessionPreset];
}

#pragma mark -- Custom Method
- (JRLiveVideoSessionPreset)supportSessionPreset:(JRLiveVideoSessionPreset)sessionPreset {
    ...
    if (![session canSetSessionPreset:self.avSessionPreset]) {
        if (sessionPreset == JRCaptureSessionPreset720x1280) {
            sessionPreset = JRCaptureSessionPreset540x960;
            if (![session canSetSessionPreset:self.avSessionPreset]) {
                sessionPreset = JRCaptureSessionPreset360x640;
            }
        } else if (sessionPreset == JRCaptureSessionPreset540x960) {
            sessionPreset = JRCaptureSessionPreset360x640;
        }
    }
...
- (BOOL)isEqual:(id)other {
    if (other == self) {
        ...
        JRLiveVideoConfiguration *object = other;
...
- (id)copyWithZone:(nullable NSZone *)zone {
    JRLiveVideoConfiguration *other = [self.class defaultConfiguration];
    return other;
}
